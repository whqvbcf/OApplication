...
import com.example.myapplication.service.IdleModeService;
import com.example.myapplication.ui.adapter.WifiSpinnerAdapter;
import com.example.myapplication.ui.widget.MarqueeTextView;
import com.example.myapplication.ui.widget.WifiExSpinner;
import com.example.myapplication.ui.widget.WifiSpinner;
...
//        });
    ...
    private MarqueeTextView mConsumerTitle;
    ...
    private void setConsumerActionBar(CharSequence title) {
        ...
        mConsumerTitle = new MarqueeTextView(this);
