 ...
 * 原名：NumPadKey
 */
public class NumPadKeyView extends ViewGroup {
    ...
    private OnClickListener mListener = new OnClickListener() {
        ...
        public void onClick(View thisView) {
            if (mTextView == null && mTextViewResId > 0) {
                final View v = NumPadKeyView.this.getRootView().findViewById(mTextViewResId);
    ...
    public NumPadKeyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NumPadKeyView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, R.layout.view_keyguard_num_pad_key);
    }

    protected NumPadKeyView(Context context, AttributeSet attrs, int defStyle, int contentResource) {
        ...
        setBackground(getResources().getDrawable(R.drawable.ripple_drawable));
