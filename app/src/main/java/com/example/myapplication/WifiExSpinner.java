    ...
    private void setDropdownWidthToScreenWidth(Context context) {
        ...
        try {
            ...
            if (popupWindow != null) {
                ...
                Log.d("WifiExSpinner", "Horizontal offset set to: " + horizontalOffset);
            }
        } catch (Exception e) {
            Log.e("WifiExSpinner", "Error setting horizontal offset", e);
        }
    }
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (hasWindowFocus) {
            try {
                ...
                Log.e("WifiExSpinner", "Error setting vertical offset", e);
            }
        }
    }
