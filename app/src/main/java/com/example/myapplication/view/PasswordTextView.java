...
public class PasswordTextView extends View {
    ...
    public PasswordTextView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        try {
            mTextHeightRaw = a.getInt(R.styleable.PasswordTextView_scaledTextSize, 10);
...
//                Settings.System.TEXT_SHOW_PASSWORD, 1) == 1;
        ...
        mDisappearInterpolator = AnimationUtils.loadInterpolator(context,
    ...
    private CharSequence getTransformedText() {
        ...
        for (int i = 0; i < textLength; i++) {
            ...
            stringBuilder.append(charState.whichChar);
        }
        Log.i("qqq-->>", "getTransformedText: " + stringBuilder);
...
//                (isFocused() || isSelected() && isShown())) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        //info.setInputType(InputType.TYPE_NUMBER_VARIATION_NORMAL);
    ...
    private class CharState {
        ...
        public float draw(Canvas canvas, float currentDrawPosition, int charHeight, float yPosition,
            ...
            //Log.i("qqq","textVisible: "+textVisible+" dotVisible:"+dotVisible + " charWidth:"+charWidth);
            if (textVisible) {
